...
System.register(['typer', 'get-prop', 'aurelia-logging', 'aurelia-validation', 'aurelia-dependency-injection', 'aurelia-metadata', 'aurelia-api', 'aurelia-binding', 'aurelia-templating'], function (_export, _context) {
  "use strict";

  var typer, getProp, getLogger, ValidationRules, Validator, transient, Container, inject, metadata, Config, bindingMode, BindingEngine, bindable, customElement, _createClass, _typeof, _dec, _class, _dec2, _class2, _dec3, _class4, _class5, _temp, _dec4, _class6, _dec5, _dec6, _dec7, _dec8, _class8, _desc, _value, _class9, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _dec9, _dec10, _dec11, _dec12, _class11, _desc2, _value2, _class12, _descriptor15, _descriptor16, _descriptor17, _descriptor18, _descriptor19, _descriptor20, _descriptor21, logger, DefaultRepository, EntityManager, Entity, OrmMetadata, Metadata, Repository, AssociationSelect, Paged;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('EntityManager', EntityManager = (_dec2 = inject(Container), _dec2(_class2 = function () {
      ...
      _export('Entity', Entity = (_dec3 = transient(), _dec3(_class4 = function () {
        function Entity() {
      ...
      _export('Repository', Repository = (_dec4 = inject(Config), _dec4(_class6 = function () {
      ...
      _export('AssociationSelect', AssociationSelect = (_dec5 = customElement('association-select'), _dec6 = inject(BindingEngine, EntityManager, Element), _dec7 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec8 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec5(_class8 = _dec6(_class8 = (_class9 = function () {
      ...
      _export('Paged', Paged = (_dec9 = customElement('paged'), _dec10 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec11 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec12 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec9(_class11 = (_class12 = function () {
        function Paged() {
