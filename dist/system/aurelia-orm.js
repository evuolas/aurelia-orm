...
System.register(['typer', 'aurelia-dependency-injection', 'aurelia-api', 'aurelia-metadata', 'aurelia-validation', 'aurelia-logging', './component/association-select', './component/paged'], function (_export, _context) {
  ...
  var typer, inject, transient, Container, Config, metadata, Validator, ValidationRules, getLogger, AssociationSelect, Paged, _typeof, _createClass, _dec, _class, _dec2, _class3, _class4, _temp, _dec3, _class5, _dec4, _class6, Repository, DefaultRepository, OrmMetadata, Metadata, Entity, EntityManager, logger;
