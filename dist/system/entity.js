...
System.register(['aurelia-dependency-injection', './orm-metadata'], function (_export, _context) {
  "use strict";

  var transient, OrmMetadata, _typeof, _dec, _class, Entity;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('Entity', Entity = (_dec = transient(), _dec(_class = function () {
        function Entity() {
